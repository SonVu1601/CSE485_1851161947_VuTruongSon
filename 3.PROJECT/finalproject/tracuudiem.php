...
<header class="siteheader fixed-top">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class=" navbar-nav menu">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a href="/profile/location">Tổng hợp các cơ sở học tập</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class=" dropdown-toggle nav_content" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
    ...
    <div class="page-title">
        <h1 style="color:#fff;font-weight:bold;font-weight:bold" class="nomargin">Giới thiệu</h1>
    </div>
    <div class="column  box-news last" style="border:1px solid #ddd;width:60%;margin-left: auto;margin-right: auto;" >
        <div class="panel panel-blue">

            <div class="panel-body" style="padding:15px 15px">
                <div class="lichkhaigiang">
                    <div class="webou" style="display:flex;width:100%;">
                        <div class="webmail" style="width:20%;">
                            <a href="https://mail.google.com" target="_blank">
                                <img style="height:120px" src="http://www.oude.edu.vn/www/images/mail.png">
                                <br>Email tên miền oude.edu.vn
                            </a>


                        </div>
                        <div class="widget widget_recent_comments xemdiemthi" style="width:60%;" >
                            <div class="widget-title">
                                <h3 class="nomargin">Xem điểm thi</h3>
                            </div>
                            <form method="get" target="_blank" action="http://diemtx.ou.edu.vn/modules.php" class="form-xemdiem"">
                                <div class="row-col  search-content " >
                                    <div class="column eightcol">
                                        <input type="text" name="txtMssv" value="" placeholder="Nhập MSSV" style="width:300px;height:50px; font-size: 1.4rem;">
                                    </div>
                                    <div class="column threecol"type="submit" style="width:25%;margin-left:auto;margin-right:auto;padding-top:10px;">
                                        <button class="button large primary" type="submit" style="width:100px;margin-left:auto">Tìm</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 p-left p-right" style="padding-top: 15px;padding-bottom: 15px;">
                    <address>
                        <p style="float: left;">
                            ...
                            <br>
                            Room 004, 97 Vo Van Tan street, 6th Ward, 3rd Dist., Ho Chi Minh City, Vietnam - Tel:
                            18006119
                            <br>
                            Website:
